<template>
  <div class="login-container">
    <a class="tecSupport" v-if="tecSupport" :href="tecSupportUrl">技术支持:{{tecSupport}}</a>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      tecSupport:settings.tecSupport,
      tecSupportUrl:settings.tecSupportUrl,
      loginForm: {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          this.$store.dispatch('user/login', this.loginForm)
            ...
            .catch(() => {
              console.log("服务端验证失败，由拦截器处理，也可以在此处进行进一步处理");
              this.loading = false
            })
        } else {
          console.log('客户端验证失败，未提交服务器')
          return false
        }
      })
    }
